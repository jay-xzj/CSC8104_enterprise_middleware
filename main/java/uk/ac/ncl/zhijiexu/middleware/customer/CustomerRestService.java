...
/**
 * <p> CustomerRestService provides RESTFul APIs of class Customer </p>
 *
 * @author JayXu
...
public class CustomerRestService {
    ...
    public Response retrieveAllCustomers(@QueryParam("name") String name) {
        ...
        try {
            ...
            ne.printStackTrace();
            log.severe("NoResultException while retrieving all customers : " + ne.getMessage());
            return Response.status(Response.Status.NOT_FOUND).entity(customers).build();
        }
